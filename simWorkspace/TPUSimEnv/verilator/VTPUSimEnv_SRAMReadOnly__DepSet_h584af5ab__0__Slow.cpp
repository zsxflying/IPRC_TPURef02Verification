...
VL_ATTR_COLD void VTPUSimEnv_SRAMReadOnly___eval_initial__TOP__TPUSimEnv__sramW0(VTPUSimEnv_SRAMReadOnly* vlSelf) {
    ...
    VL_DEBUG_IF(VL_DBG_MSGF("+        VTPUSimEnv_SRAMReadOnly___eval_initial__TOP__TPUSimEnv__sramW0\n"); );
    // Body
    VL_READMEM_N(false, 32, 128, 0, VL_CVT_PACK_STR_NW(24, VTPUSimEnv__ConstPool__CONST_hc4c7531a_0)
                 ,  &(vlSelf->mem), 0, ~0ULL);
}

VL_ATTR_COLD void VTPUSimEnv_SRAMReadOnly___ctor_var_reset(VTPUSimEnv_SRAMReadOnly* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    VTPUSimEnv__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+        VTPUSimEnv_SRAMReadOnly___ctor_var_reset\n"); );
    // Body
