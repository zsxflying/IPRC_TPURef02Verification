...
class alignas(VL_CACHE_LINE_BYTES)VTPUSimEnv__Syms final : public VerilatedSyms {
  public:
    ...
    VTPUSimEnv_SRAMReadOnly_2      TOP__TPUSimEnv__sramD0;
    VTPUSimEnv_SRAMReadOnly_3      TOP__TPUSimEnv__sramD1;
    ...
    VTPUSimEnv_SRAMReadOnly        TOP__TPUSimEnv__sramW0;
    VTPUSimEnv_SRAMReadOnly_1      TOP__TPUSimEnv__sramW1;
