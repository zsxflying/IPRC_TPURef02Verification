...
VL_INLINE_OPT void VTPUSimEnv_SRAMWriteOnly_1___nba_sequent__TOP__TPUSimEnv__sramRes1__0(VTPUSimEnv_SRAMWriteOnly_1* vlSelf) {
    ...
    if ((1U & (~ (IData)(vlSymsp->TOP__TPUSimEnv.__PVT__tpu_1__DOT__tpuVerilog_sram_write_enable_b0)))) {
        vlSelf->__Vlvbound_ha17ce783__0[0U] = vlSymsp->TOP__TPUSimEnv.__PVT__tpu_1__DOT__tpuVerilog_sram_wdata_b[0U];
        vlSelf->__Vlvbound_ha17ce783__0[1U] = vlSymsp->TOP__TPUSimEnv.__PVT__tpu_1__DOT__tpuVerilog_sram_wdata_b[1U];
        vlSelf->__Vlvbound_ha17ce783__0[2U] = vlSymsp->TOP__TPUSimEnv.__PVT__tpu_1__DOT__tpuVerilog_sram_wdata_b[2U];
        vlSelf->__Vlvbound_ha17ce783__0[3U] = vlSymsp->TOP__TPUSimEnv.__PVT__tpu_1__DOT__tpuVerilog_sram_wdata_b[3U];
        if ((0xeU >= (0xfU & (IData)(vlSymsp->TOP__TPUSimEnv.__PVT__tpu_1__DOT__tpuVerilog_sram_waddr_b)))) {
