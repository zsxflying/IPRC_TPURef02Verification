...
public:
    ...
    Wrapper_1(const char * name){
      ...
      top.trace(&tfp, 99);
      tfp.open((std::string("/home/rick/NTTAccelerator/example/TPU_verification/./simWorkspace/TPUSimEnv/") + name + ".vcd").c_str());
      #endif
      this->name = name;
    ...
    virtual ~Wrapper_1(){
      ...
      #endif
      #ifdef COVERAGE
      VerilatedCov::write((("/home/rick/NTTAccelerator/example/TPU_verification/./simWorkspace/TPUSimEnv/") + name + ".dat").c_str());
      #endif
    }
