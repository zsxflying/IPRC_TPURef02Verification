...
VL_INLINE_OPT void VTPUSimEnv_SRAMReadOnly_2___nba_sequent__TOP__TPUSimEnv__sramW0__0(VTPUSimEnv_SRAMReadOnly_2* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    VTPUSimEnv__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+        VTPUSimEnv_SRAMReadOnly_2___nba_sequent__TOP__TPUSimEnv__sramW0__0\n"); );
    // Body
    vlSelf->__PVT___zz_mem_port0 = ((0x1eU >= (0x1fU 
                                               & (IData)(vlSymsp->TOP__TPUSimEnv.__PVT__tpu_1__DOT__tpuVerilog_sram_raddr_w0)))
                                     ? vlSelf->mem[
                                    (0x1fU & (IData)(vlSymsp->TOP__TPUSimEnv.__PVT__tpu_1__DOT__tpuVerilog_sram_raddr_w0))]
